  ...
  return (
    <div className="container">
      <section className={styles.section}>
        ...
        <Button linkTo="/level-menu">Продолжить как гость</Button>
        <img
          className={`${styles.section__img} ${styles.section__img_glasses}`}
          src={GlassesSvg}
      ...
      <section className={`${styles.section} ${styles.section_rightSide}`}>
        <div className={styles.section__text}>
          <p className={styles.section__text_last}>
            В начале игры <b>будьте рядом с ребЁнком</b> и помогайте, если что-то не будет получаться.{' '}
            <b>внимание и поддержка родителя</b> очень важны для когнитивного развития ребёнка.
          </p>
          <Button linkTo="/level-menu">Начать</Button>
          <img
            className={`${styles.section__img} ${styles.section__img_hands}`}
            src={HandsSvg}
            alt="Иллюстрация к тексту"
          />
        </div>
      ...
      <section className={styles.section}>
        ...
        <Button linkTo="/level-menu">Начать</Button>
        <img
          className={`${styles.section__img} ${styles.section__img_clock}`}
          src={ClockSvg}
          alt="Иллюстрация к тексту"
        />
      </section>
      <section className={`${styles.section} ${styles.section_rightSide}`}>
        <div className={styles.section__text}>
          ...
          <Button linkTo="/level-menu">Начать</Button>
          <img
            className={`${styles.section__img} ${styles.section__img_heart}`}
            src={HeartSvg}
            alt="Иллюстрация к тексту"
          />
        </div>
