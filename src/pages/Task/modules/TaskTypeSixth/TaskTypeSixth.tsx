...
import { ISimpleTask, ITask } from '@/pages/Task/exercise.types'
...
const TaskTypeSixth: React.FC<TaskTypesProps> = ({ task }) => {
  ...
  if (!isSimpleTask(task)) return null
  ...
  const handleDragEnd = (result: DropResult) => {
    ...
    if (result.destination.droppableId === 'image') {
      ...
      new Audio(movedWord.content === rightWord.text ? rightAnswerSound : wrongAnswerSound).play()
    }
  }
